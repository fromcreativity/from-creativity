 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260812c.js
 *
...
.theme-cat{
  font-family:var(--serif-jp);font-size:14.5px;font-weight:500;
  color:var(--paper);letter-spacing:0.08em;margin-bottom:9px;
}
.theme-desc{
...
@media (max-width: 768px){
  ...
  .themes{padding:64px 24px}
  .themes-grid{grid-template-columns:1fr;gap:12px}
  .theme-card{padding:16px 18px}
  .theme-cat{font-size:13.5px;margin-bottom:7px}
  .theme-desc{font-size:12px;line-height:1.9}
  .themes-lead{font-size:13.5px;line-height:2}
...
<section class="themes" id="themes">
  ...
  <div class="themes-grid">
    <div class="theme-card reveal">
      ...
      <p class="theme-desc">サービスの説明だけでなく、<em>代表がどんな思いで会社を始めたのか</em>、社員が普段どう働いているのかまで伝わる会社紹介映像を制作します。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">採用・リクルート動画</div>
      <p class="theme-desc">社員インタビューを並べるだけでなく、<em>ひとりの社員の仕事に密着</em>し、職場の雰囲気と人柄が自然に伝わる採用動画に仕上げます。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">店舗・飲食店</div>
      <p class="theme-desc">料理や店内をきれいに撮るだけでなく、<em>店主の人柄と、なぜこの店を始めたのか</em>まで描く店舗 PR 映像を制作します。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">職人・工房・ものづくり</div>
      <p class="theme-desc">インタビューだけでなく、<em>実際の作業風景をじっくり撮影</em>し、技術と仕事への考え方が伝わる職人ドキュメンタリーを制作します。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">創業○周年・社史</div>
      <p class="theme-desc">形式的な記念動画ではなく、<em>創業者や長く働いてきた社員の言葉</em>から、会社の歴史とそこに関わった人たちを描きます。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">作家・クリエイター</div>
      <p class="theme-desc">作品そのものの紹介ではなく、<em>どんな場所で何を考えながら制作しているのか</em>、制作過程や日常まで撮影します。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">保育園・幼稚園・学校</div>
      <p class="theme-desc">設備や教育方針を説明する PR 動画ではなく、<em>子どもたちと先生の普段の様子</em>を撮影し、どんな場所なのかが自然に伝わる映像に。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">福祉・NPO・社会活動</div>
      <p class="theme-desc">代表者が説明するだけでなく、<em>実際に活動している人・利用している人の日常</em>を通して、活動の意味を伝えます。</p>
    </div>
    <div class="theme-card reveal">
      <div class="theme-cat">地域・まちづくり</div>
      <p class="theme-desc">観光地を並べる PR 動画ではなく、<em>そこで暮らす人・商売をしている人</em>を通して、その土地らしさが伝わる映像を制作します。</p>
    </div>
    <div class="theme-card reveal">
    ...
    <div class="theme-card reveal">
      ...
      <p class="theme-desc">完成した商品の紹介動画ではなく、<em>完成までの過程と、開発した人たちの思い</em>を、数日間の取材でストーリーとしてまとめます。</p>
    </div>
    <div class="theme-card reveal">
