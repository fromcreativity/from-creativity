 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260813.js
 *
...
@media (max-width: 768px){
  ...
  .theme-card{padding:13px 12px;border-left-width:2px}
  .theme-cat{font-size:12px;margin-bottom:5px;letter-spacing:0.04em;line-height:1.4}
