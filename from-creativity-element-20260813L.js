 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260813L.js
 *
...
(function(){
  ...
  const VERSION = '2026-08-13L-SAFE';
  ...
  class FromCreativityPageV4 extends HTMLElement {
    ...
    trimWixGap() {
      try {
        ...
        /* <main> を中身の高さに戻す（min-height は height より強いので必ず0に） */
        ...
        /* ホスト要素だけを中身に合わせる。
           ★祖先は触らない★
           祖先（Wixのセクション）にはWixのテキストなど他のコンテンツも
           入っているため、高さを詰めるとそれらを切り落としてしまう。 */
