 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260813M.js
 *
...
(function(){
  ...
  const VERSION = '2026-08-13M-FINDER';
  ...
  class FromCreativityPageV4 extends HTMLElement {
    ...
    trimWixGap() {
      try {
        ...
        if (this._diag.docH - realH > 200 && window.innerWidth <= 900) this.fcDebugPanel(true);
