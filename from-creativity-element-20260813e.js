 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260813e.js
 *
...
/* ===========================================================
   Wixウィジェットの高さが中身より大きいとき、余りが黒く見える対策。
   .fc-app を縦フレックスにして、最後のタグラインが余白を吸収する。
   高さが足りている場合は通常どおりに流れるため副作用はない。
   =========================================================== */
.fc-app{display:flex;flex-direction:column;min-height:100%}
.fc-app > section,
.fc-app > div{flex:0 0 auto}
.fc-app > .tagline{
  flex:1 1 auto;
...
from-creativity-page-v4{display:block !important;margin:0 !important;padding:0 !important;width:100% !important;max-width:100% !important;box-sizing:border-box !important;position:relative !important;left:0 !important;height:100% !important}
