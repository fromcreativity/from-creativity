 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260903Q.js
 *
...
(function(){
  ...
  const VERSION = '2026-09-03Q-LEGALLINK';
...
.legal-link{margin-top:56px;padding-top:28px;border-top:1px solid rgba(194,160,109,0.18);max-width:420px;margin-left:auto;margin-right:auto}
.legal-link a{
  font-family:var(--sans-jp);font-size:11.5px;font-weight:300;
  color:rgba(245,241,232,0.45);letter-spacing:0.14em;text-decoration:none;
  border-bottom:1px solid transparent;padding-bottom:3px;
  transition:color .45s,border-color .45s;
}
.legal-link a:hover{color:var(--gold);border-bottom-color:var(--gold-soft)}
...
@media (max-width: 480px){
  ...
  .legal-link{margin-top:36px;padding-top:20px}
  .legal-link a{font-size:10.5px;letter-spacing:0.1em}
...
<nav class="top">
  ...
  <ul id="navMenu">
    ...
    <li><a href="https://www.from-creativity.com/legal" target="_top">Legal</a></li>
  </ul>
</nav>
