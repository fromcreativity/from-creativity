 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260903S.js
 *
...
(function(){
  ...
  const VERSION = '2026-09-03S-NAVFIX';
...
@media (max-width: 768px){
  ...
  nav.top ul li.nav-div{width:100%;height:1px;margin:14px 0}
  nav.top ul a.nav-page{display:block;text-align:center;margin:6px 0;padding:12px 16px}
