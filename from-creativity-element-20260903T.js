 ...
 *  Server URL: https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-element-20260903T.js
 *
...
(function(){
  ...
  const VERSION = '2026-09-03T-MOBILE';
...
@media (max-width: 768px){
  ...
  nav.top ul{display:flex;flex-direction:column;gap:0;position:fixed;top:60px;left:0;right:0;background:#0A0907;padding:14px 20px 26px;border-top:1px solid var(--gold-soft);transform:translateY(-120%);transition:transform .4s cubic-bezier(.7,0,.3,1);pointer-events:none;max-height:calc(100vh - 60px);overflow-y:auto;-webkit-overflow-scrolling:touch;overscroll-behavior:contain}
  nav.top ul{max-height:calc(100dvh - 60px)}
  nav.top ul li.nav-div{width:100%;height:1px;margin:8px 0}
