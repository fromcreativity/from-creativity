...
.fc-app .hero-cinematic .hero-grid{
  ...
  min-height:clamp(780px,98svh,980px);
  margin:0 auto;
  padding:clamp(112px,12vh,148px) 0 72px clamp(52px,5.5vw,106px);
}
...
.fc-app .hero-cinematic .hero-media::after{
  ...
  box-shadow:none;
  background:
    linear-gradient(90deg,#080705 0%,rgba(8,7,5,.96) 7%,rgba(8,7,5,.76) 17%,rgba(8,7,5,.28) 29%,transparent 38%),
    linear-gradient(180deg,rgba(8,7,5,.86) 0%,rgba(8,7,5,.18) 8%,transparent 17%,transparent 83%,rgba(8,7,5,.22) 92%,rgba(8,7,5,.88) 100%);
}
...
@media (max-width:1100px) and (min-width:961px){
  ...
  .fc-app .hero-cinematic .hero-text{width:52vw}
  .fc-app .hero-cinematic h1{
    width:100%;
    font-size:58px;
    line-height:1.18;
...
@media (max-width:960px){
  ...
  .fc-app .hero-cinematic .hero-media::after{
    ...
    box-shadow:none;
    background:
      linear-gradient(90deg,rgba(8,7,5,.72) 0%,transparent 6%,transparent 94%,rgba(8,7,5,.72) 100%),
      linear-gradient(180deg,rgba(8,7,5,.78) 0%,transparent 9%,transparent 91%,rgba(8,7,5,.78) 100%);
  }
  .fc-app .hero-reel-ui{
    display:block;
    margin-top:0;
