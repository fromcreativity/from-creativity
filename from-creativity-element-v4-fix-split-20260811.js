...
.fc-app .hero-cinematic .hero-grid{
  ...
  z-index:2 !important;
  display:grid;
  grid-template-columns:minmax(380px,.85fr) minmax(520px,1.35fr);
  align-items:center;
  gap:clamp(38px,4.3vw,72px);
  width:min(100%,1600px);
  min-height:clamp(680px,92svh,900px);
  margin:0 auto;
  padding:clamp(112px,13vh,150px) clamp(30px,3.6vw,58px) 82px;
}
...
.fc-app .hero-cinematic .hero-media{
  ...
  aspect-ratio:16/9;
  overflow:hidden;
  border:1px solid rgba(194,160,109,.28);
  border-radius:4px;
  background:#000;
  box-shadow:
    0 30px 90px rgba(0,0,0,.56),
    0 18px 70px rgba(194,160,109,.16),
    0 0 0 1px rgba(245,241,232,.025);
}
.fc-app .hero-cinematic .hero-media::after{
  ...
  box-shadow:inset 0 0 34px 10px rgba(5,5,4,.42);
  background:linear-gradient(180deg,rgba(5,5,4,.18),transparent 14%,transparent 84%,rgba(5,5,4,.22));
}
...
@media (max-width:1100px) and (min-width:961px){
  .fc-app .hero-cinematic .hero-grid{
    grid-template-columns:minmax(350px,.82fr) minmax(500px,1.25fr);
    gap:32px;
    padding-right:30px;
    padding-left:30px;
  }
  .fc-app .hero-cinematic h1{font-size:34px}
  .fc-app .hero-cinematic .lead{font-size:13px}
...
@media (max-width:960px){
  ...
  .fc-app .hero-title-line--long{font-size:.79em;white-space:nowrap}
  .fc-app .hero-cinematic h1 em{
    margin-top:16px;
    font-size:10.5px;
    line-height:1.65;
  ...
  .fc-app .hero-cinematic .hero-media{
    ...
    border-left:0;
    border-radius:0;
    box-shadow:0 24px 60px rgba(0,0,0,.50),0 12px 50px rgba(194,160,109,.12);
  }
  .fc-app .hero-cinematic .hero-media::after{
    border-radius:0;
    box-shadow:inset 0 0 22px 4px rgba(5,5,4,.34);
  }
  .fc-app .hero-reel-ui{
    display:block;
    margin-top:0;
...
@media (max-width:380px){
  ...
  .fc-app .hero-visual{width:calc(100% + 28px);margin-left:-14px}
  .fc-app .hero-cinematic h1{font-size:23px}
