 ...
 *  Wix Custom Element
 *
 *  VERSION: 2026-09-03b-LEGAL
 *  ↑ この行でバージョンを判別できます。
 *
 *  【Wix側の設定】
 *    Server URL :
 *      https://cdn.jsdelivr.net/gh/fromcreativity/from-creativity@main/from-creativity-legal-20260903b.js
...
(function () {
  ...
  const VERSION = '2026-09-03b-LEGAL';
...
<main class="fcl">
  ...
  <div class="fcl-body">
    <div class="fcl-dl">
      ...
      <div class="fcl-row">
        ...
        <div class="fcl-dd">
          <ul>
            ...
            <li>DVD・USBメモリでの物理納品をご希望の場合の実費</li>
            <li>お振込手数料</li>
          </ul>
      ...
      <div class="fcl-row">
        ...
        <div class="fcl-dd">
          <p>納品した映像に当方の作業上の不備があった場合は、無償で修正いたします。納品後14日以内にご連絡ください。</p>
  ...
  <footer class="fcl-foot">
    ...
    <div class="fcl-copy">© 2025 SHUMPEI SASAKI</div>
  </footer>
